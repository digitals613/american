...
export class DoorToDoorTransportationComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.metaTagService.updateTag(
      { name: 'description', content: 'AQ Movers is one of the best Door to Door Car Shipping Company in Usa. AQ Movers wants you to experience only high-quality Door to Door services' }
    );
    this.metaTagService.updateTag(
