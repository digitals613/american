...
export class CaliforniaToTexasComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.metaTagService.updateTag(
      { name: 'description', content: 'AQ Movers has professionally trained drivers to carry out your car shipping from California to Texas. We provide non-stop and door-to-door car shipping.' }
    );
    this.metaTagService.updateTag(
