...
export class GeorgiaCarShippingComponent implements OnInit {
  ...
  ngOnInit(): void {
    window.scroll(0,0)
    this.titleService.setTitle('Georgia Auto Transport | Car shipping service | AQ Movers Auto Shipping');
    this.metaTagService.updateTag(
      { name: 'description', content: 'AQ Movers is known for its professional and quality Georgia auto transport. We are committed to safe, efficient, and affordable car shipping.' }
    );
    this.metaTagService.updateTag(
